    ...
    <footer class="bg-slate-900 text-white pt-16 pb-8 rounded-t-[3rem] mt-12">
      <app-container>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div class="space-y-4">
            <h3
              class="text-2xl font-bold bg-linear-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent"
            >
              ArtTouch
            </h3>
            <p class="text-slate-400 leading-relaxed">
              Elevating spaces with curated modern art. We believe in the power of aesthetics to
              transform everyday life.
            </p>
            <div class="flex space-x-4 pt-2">
              <a
                href="#"
                class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-indigo-600 transition-colors"
              >
              ...
              <a
                href="#"
                class="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center hover:bg-sky-500 transition-colors"
              >
          ...
          <div>
            ...
            <ul class="space-y-4">
              ...
              <li>
                <a href="#" class="text-slate-400 hover:text-white transition-colors">Gift Cards</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form class="flex flex-col gap-3">
              <input
                ...
                class="w-full px-4 py-3 rounded-xl bg-slate-800 border border-slate-700 text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
              />
              <button
                type="button"
                class="w-full px-4 py-3 bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 transition-colors shadow-lg shadow-indigo-900/30"
              >
                Subscribe
              </button>
            </form>
