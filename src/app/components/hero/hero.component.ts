...
@Component({
    ...
    <section class="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden">
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <span class="inline-block py-1 px-3 rounded-full bg-indigo-50 text-indigo-600 text-sm font-semibold mb-6 border border-indigo-100">
          New Collection 2025
        </span>
        ...
        <p class="mt-4 text-xl text-slate-600 max-w-2xl mx-auto mb-10 leading-relaxed">
          Curated collection of modern abstract art, digital masterpieces, and handcrafted sculptures designed to elevate your living space.
        </p>
        
        <div class="flex flex-col sm:flex-row justify-center gap-4">
          <button class="px-8 py-4 bg-slate-900 text-white rounded-full font-semibold hover:bg-slate-800 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
            Shop Now
          </button>
          <button class="px-8 py-4 bg-white text-slate-900 border border-slate-200 rounded-full font-semibold hover:bg-slate-50 hover:border-slate-300 transition-all duration-300">
            View Gallery
          </button>
        </div>
        
        <!-- Stats / Social Proof -->
        <div class="mt-16 pt-8 border-t border-slate-100 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
          <div>
